...
- [Data Sources](DATA_SOURCES.md) — Source categories, public references, official reports, and archived evidence links / 出典カテゴリ、公式資料、調査レポート、アーカイブリンクの整理
- [Methodology](METHODOLOGY.md) — Data definitions, assumptions, estimation methods, and limitations / データ定義、推計方法、前提条件、制約事項の説明
